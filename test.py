...
data_directory = '/mnt/cluster/workspaces/students/schreibpa/embeddings/endoViT/Cholec80/'
...
with torch.inference_mode(): 
    ...
    file_path = '10_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '20_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '30_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '40_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '50_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '60_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '70_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '80_percent_selected_image_paths.txt'
    ...
    # Define the path to the file
    file_path = '90_percent_selected_image_paths.txt'
