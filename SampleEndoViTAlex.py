...
data_directory = '/mnt/cluster/workspaces/students/schreibpa/embeddings-small/endoViTAlex/Cholec80/'
...
with torch.inference_mode(): 
    ...
    # Define the path to the "endoViTAlex" folder
    endoViTAlex_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'endoViTAlex')

    # Create the directory if it does not exist
    os.makedirs(endoViTAlex_dir, exist_ok=True)

    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '10_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '20_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '30_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '40_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '50_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '60_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '70_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '80_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoViTAlex" folder
    file_path = os.path.join(endoViTAlex_dir, '90_percent_selected_image_paths.txt')
