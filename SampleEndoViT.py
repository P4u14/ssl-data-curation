...
def load_embeddings(data_directory):
    ...
    for sub_directory in sub_directory_list:
        ...
        print("Loading " + str(sub_directory))
...
data_directory = '/mnt/cluster/workspaces/students/schreibpa/embeddings-small/endoViT/Cholec80/'
...
with torch.inference_mode(): 
    ...
    data_tensor = torch.tensor(data, device="cpu", dtype=torch.float32)

    print("Loaded data")
    print("Start hierarchical kmeans with resampling")
