...
data_directory = '/mnt/cluster/workspaces/students/schreibpa/embeddings-small/dinoV2/Cholec80/'
...
with torch.inference_mode(): 
    ...
    # Define the path to the "dinoV2" folder
    dinoV2_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dinoV2')

    # Create the directory if it does not exist
    os.makedirs(dinoV2_dir, exist_ok=True)

    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '10_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '20_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '30_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "endoVidinoV2T" folder
    file_path = os.path.join(dinoV2_dir, '40_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '50_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '60_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '70_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '80_percent_selected_image_paths.txt')
    ...
    # Define the file path within the "dinoV2" folder
    file_path = os.path.join(dinoV2_dir, '90_percent_selected_image_paths.txt')
